...
export const anmolProfile: MemberProfile = {
  ...
  philosophyQuote: {
    text: 'Great brands are not made through loud claims, but through consistently distinct value delivered with precision.',
  ...
  responsibilities: [
    {
      ...
      summary: 'Brand leadership, customer acquisition, growth strategy, and go-to-market execution.',
      items: [
        'Brand',
  ...
  competencies: [
    {
      ...
      skills: ['Brand Identity', 'Narrative Craft', 'Positioning Architecture', 'Content Marketing', 'Creative Direction']
    },
    {
      category: 'Growth & Acquisition',
      skills: ['Customer Acquisition', 'GTM Execution', 'Paid & Organic Funnels', 'Conversion Optimization', 'Lifecycle Marketing']
    },
    {
      category: 'Analytics & Distribution',
      skills: ['Attribution Modeling', 'Market Research', 'SEO / Distribution', 'Partnership Channels', 'Campaign Optimization']
    }
  ],
  projects: [
    {
      id: 'avenue-butwal',
      title: 'Avenue Butwal Launch Campaign & Digital Identity',
      client: 'Avenue Butwal',
      year: '2024',
      role: 'Growth Strategist & Campaign Director',
